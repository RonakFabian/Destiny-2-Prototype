...
void AD2Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AD2Character::OnFire);
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AD2Projectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void AD2Character::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AD2Character::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AD2Character::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AD2Character::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AD2Character::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AD2Character::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AD2Character::TouchUpdate);
		return true;
	}
